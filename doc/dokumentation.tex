...
\Cmd{usepackage} läd Pakete und Styles in das Dokument. Mit dem Paket \emph{inputenc} wird die Kodierung der Datei angegeben. Die \LaTeX-Dateien müssen entsprechend kodiert sein, wobei \emph{utf8} aus Gründen der Plattformunabhängigkeit und des Zeichensatzes am zweckmäßigsten ist.
...
d)&\includegraphics[width=14.2cm]{sonsttab}
\end{tabularx}
}
